...
*/
	...
	/**
	* 新加方法
	* @param local_filename 文件绝对路径
	* @param meta_list 附加信息
	* @return 返回fid
	*/
	public String upload_file1(String local_filename, NameValuePair[] meta_list) throws IOException, MyException
	{
		//文件名后缀
	 ...
	 * @return 返回fid
	 */
	public String upload_file1(String local_filename, Map<String, String> metaMap) throws IOException, MyException
	{
		//文件名后缀
		String file_ext_name = local_filename.substring(local_filename.lastIndexOf(".")+1, local_filename.length());
		String parts[] = this.upload_file(local_filename, file_ext_name, metaMap);
		if (parts != null)
		{
			return parts[0] + SPLIT_GROUP_NAME_AND_FILENAME_SEPERATOR + parts[1];
		}
